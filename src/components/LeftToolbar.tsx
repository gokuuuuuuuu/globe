...
export function LeftToolbar() {
  ...
  const [isRiskTypeFilterCollapsed, setIsRiskTypeFilterCollapsed] =
    useState(true);
  ...
  return (
    <div className="left-toolbar">
      ...
      {/* 工具栏和内容区域 - 可收起 */}
      <div
        className={`toolbar-content-wrapper ${isSidebarCollapsed ? "collapsed" : ""}`}
      >
        {/* 可折叠工具栏 */}
            ...
            <div className="toolbar-collapse-container">
              ...
              >
                <img
                  src={iconArrow}
                  alt="arrow"
                  className="toolbar-arrow-icon-collapsed"
                />
              </button>
            </div>
          ) : (
            <>
              <div className="toolbar-icons">
                ...
                >
                  ...
                  <img
                    src={boxActiveIcon}
                    alt="box active"
                    className="toolbar-box-bg-active"
                  />
                  <img
                    src={getViewIcon()}
                    alt="3d"
                ...
                <button
                  ...
                  onClick={() =>
                    setShowPrecipitationLayer(!showPrecipitationLayer)
                  }
                  title={
                    showPrecipitationLayer ? "隐藏降水图层" : "显示降水图层"
                  }
                >
                  <img src={boxIcon} alt="box" className="toolbar-box-bg" />
                  <img
                ...
                <button
                  ...
                  title={
                    showMoistureLayer ? "隐藏水汽通量图层" : "显示水汽通量图层"
                  }
                >
                  <img src={boxIcon} alt="box" className="toolbar-box-bg" />
                  <img
                ...
                <button
                  ...
                  title={
                    showVisibilityLayer ? "隐藏能见度图层" : "显示能见度图层"
                  }
                >
                  <img src={boxIcon} alt="box" className="toolbar-box-bg" />
                  <img
              ...
              >
                <img
                  src={iconArrow}
                  alt="arrow"
                  className="toolbar-collapse-icon"
                />
              </button>
            </>
          )}
        ...
        <div className="toolbar-content">
          ...
          <div className="filter-section">
            <div
              ...
              onClick={() =>
                setIsFlightFilterCollapsed(!isFlightFilterCollapsed)
              }
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ flightNumber: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ aircraftNumber: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({
                            largeAircraftType: e.target.value,
                          })
                        }
                      />
                      <img
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ aircraftType: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ pfTechnology: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ operatingUnit: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ departureAirport: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
                  ...
                  <div className="filter-input-group">
                    ...
                    <div className="filter-input-wrapper">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFlightFilters({ arrivalAirport: e.target.value })
                        }
                      />
                      <img
                        src={iconInputArrow}
          ...
          <div className="filter-section">
            <div
              className="filter-section-header"
              onClick={() =>
                setIsRiskTypeFilterCollapsed(!isRiskTypeFilterCollapsed)
              }
              style={{ cursor: "pointer" }}
            >
              <div className="filter-section-title-wrapper">
